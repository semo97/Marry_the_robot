...
double lower_angle_ = -0.5382;
double upper_angle_ = 0.5382;
...
int main(int argc, char** argv){
  ros::init(argc, argv, "rur_laser_angular_bound_filter");
  ros::NodeHandle n1, n2;
  input_scan_sub = n1.subscribe("/scan2", 10, input_scan_sub_callback);
